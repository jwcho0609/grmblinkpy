...
PYBIND11_MODULE(_core, m)
{
	...
	mblink.def(py::init<>(), "Defaults")
		...
		.def("rxContinuousStart", &MBLink::rxContinuousStart, "")
    ...
    .def_property("stance_leg_03", &MBLink::isStanceLeg03, nullptr)
		...
		.def("rxContinuousStop", &MBLink::rxContinuousStop, "", py::arg("waitForExit") = true)
    .def("pyParse", static_cast<int (MBLink::*)(std::string)>(&MBLink::pyParse), "")
    .def("unpack", &MBLink::unpackMessages, "")
    .def("get_accum", &MBLink::get_accum, "");
